...
print("    hires:  %s" % getattr(ComfyEdit, "EDIT_HIRES_WORKFLOW", ""))
print("    ref:    %s" % getattr(ComfyEdit, "EDIT_REF_HIRES_WORKFLOW", ""))
print("    gen:    %s" % getattr(ComfyEdit, "IMAGE_GEN_WORKFLOW", ""))
print("    desc:   %s" % getattr(ComfyEdit, "IMAGE_DESC_WORKFLOW", ""))
print("    i2v:    %s" % getattr(ComfyEdit, "I2V_WORKFLOW", ""))
print()
print("  Menu: Nuke > Pix-Edit")
print("    Edit Image... | Edit Image Hi-res... | Edit Image Ref Hi-res... | Image Gen... | Image Description... | Image to Video... | Ping Server")
print()
